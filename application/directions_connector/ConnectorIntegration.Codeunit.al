...
codeunit 50123 "Connector Integration" implements IDocumentSender, IDocumentReceiver
{
    ...
    begin
        ...
        // - Tips: Use SendContext.GetTempBlob() which returns a Temp Blob codeunit
        // - Tips: Use ConnectorRequests.ReadJsonFromBlob(TempBlob) which returns a text. Use the text to read json text from blob

        // <Add code here>

        // TODO: Set APIEndpoint text variable for request to 'enqueue' endpoint
    ...
    begin
        ...
        // TODO: Set APIEndpoint text variable to 'peek' endpoint
    ...
    begin
        ...
        // TODO: Set APIEndpoint text variable to 'dequeue' endpoint
